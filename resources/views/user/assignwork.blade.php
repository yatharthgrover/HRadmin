...
<form class="p-3 mb-2 bg-light text-dark" action="{{ route('user.work') }}" method="POST">
@csrf
<div class="results">
...
@endif
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter company name" name="company" value= "{{old ('company') }}">
  ...
  <button type="submit" class="btn btn-primary btn-lg">ASSIGN WORK</button>
</div>
 <br><br>
</form>
</div>
